...
def age_histogram():
    ...
    hist_plot.title.text = 'Age of responders according to Stackoverflow in 2019'  # type: ignore
    hist_plot.title.align = 'center'  # type: ignore
    hist_plot.title.text_color = 'black'  # type: ignore
    hist_plot.title.text_font_size = '15px'  # type: ignore
    hist_plot.xaxis.axis_label = 'Responder Age'  # type: ignore
    hist_plot.yaxis.axis_label = 'Counts'  # type: ignore
    hist_plot.y_range.start = 0  # type: ignore
...
def update_data(attr, old, new):
    ...
    plot.y_range.factors = new_source.data['y']  # type: ignore
...
# Slider
offset = Slider(title='Top Languages', value=10, start=10, end=20, step=1)
offset.on_change('value', update_data)

# Plot
plot = figure(y_range=source.data['y'], background_fill_color="#fafafa")
plot.hbar(right='x', y='y', source=source, height=0.4, color='blue', fill_alpha=0.5)
plot.title.text = 'Most popular languages according to Stackoverflow in 2019'  # type: ignore
plot.title.align = 'center'  # type: ignore
plot.title.text_color = 'black'  # type: ignore
plot.title.text_font_size = '15px'  # type: ignore
plot.xaxis.axis_label = 'Number of people using this'  # type: ignore
# ---------------------------------------------------------------------------
# Histogram
...
curdoc().title = 'Stackoverflow Poll'  # type: ignore
